 // Tulostaulu yhdelle lavalle. ESP32 ja 32*64 RGB led matrix display Viimeksi muokattu 29.11.2019
 // puhuu Suomea!
...
void setup() {
  ...
  display.print("Valitse:");

  display.setCursor(1,8);
  display.setTextColor(display.color565(0,0,255));
  display.print("A=10min.");

  display.setCursor(1,16);
  display.setTextColor(display.color565(0,0,255));
  display.print("B=30min.");

  display.setCursor(1,24);
  display.setTextColor(display.color565(0,0,255));
  display.print("C=60min.");
}
...
void loop() {
  if(stateMachine == 2){
    ...
    display.setTextSize(1);
    display.print("Kaynnistyy");
    display.drawPixel(8,0,display.color565(0, 100, 0));
     display.drawPixel(9,0,display.color565(0, 100, 0));
    display.setCursor(1,10);
    display.print("painamalla");
